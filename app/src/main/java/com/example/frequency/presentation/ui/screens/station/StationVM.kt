package com.example.frequency.presentation.ui.screens.station
...
import com.example.frequency.common.utils.share
import dagger.hilt.android.lifecycle.HiltViewModel
import javax.inject.Inject

@HiltViewModel
class StationVM @Inject constructor(
    ...
    private fun updateUser(user: User? = null) {
        if (user == null) {
            val newUserValue = User(
                ...
                if (sharedPreferences.getRegistrationType() == GAUTH) {
    ...
    companion object {
        ...
        @JvmStatic
        private val TAG = StationVM::class.java.simpleName
    }
}